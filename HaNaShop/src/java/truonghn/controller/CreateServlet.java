...
public class CreateServlet extends HttpServlet {
    private final String CREATE_PAGE_SERVLET = "CreatePageServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = CREATE_PAGE_SERVLET;
        ...
        try {
            ...
            if (fileName != null && !fileName.isEmpty()) {
                ...
                request.setAttribute("NOTIFICATION", "Successfully created new product.");
            }
            else {
                request.setAttribute("ERRORNOTIFY", "Something went wrong while upload image to server!");
            }
        }
        finally{
