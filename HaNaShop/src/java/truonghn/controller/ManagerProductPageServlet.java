 ...
 * @author SE130204
 */
@WebServlet(name = "ManagerProductPageServlet", urlPatterns = {"/ManagerProductPageServlet"})
public class ManagerProductPageServlet extends HttpServlet {
    private final String UPDATE_PAGE = "managerProduct.jsp";
