 ...
 * @author SE130204
 */
@WebServlet(name = "ViewOrAddToCartServlet", urlPatterns = {"/ViewOrAddToCartServlet"})
public class ViewOrAddToCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(button.equals("viewItem")
               || button.equals("detail")){
                url = VIEW_ITEM_SERVLET;
            }
            else if(button.equals("Add to cart")){
                url = ADD_TO_CART_SERVLET;
            }
            else if(button.equals("Return to product page")){
