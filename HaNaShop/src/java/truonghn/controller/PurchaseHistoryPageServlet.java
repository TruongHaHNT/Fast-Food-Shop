 ...
 * @author SE130204
 */
@WebServlet(name = "PurchaseHistoryPageServlet", urlPatterns = {"/PurchaseHistoryPageServlet"})
public class PurchaseHistoryPageServlet extends HttpServlet {
    private final String HISTORY_PAGE = "purchaseHistory.jsp";
    /**
