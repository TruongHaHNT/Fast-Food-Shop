...
import truonghn.itemStatus.ItemStatusDTO;
 ...
 * @author SE130204
 */
@WebServlet(name = "ManagerViewItemPageServlet", urlPatterns = {"/ManagerViewItemPageServlet"})
public class ManagerViewItemPageServlet extends HttpServlet {
    private final String AD_VIEW_ITEM_PAGE = "managerUpdateItem.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("DOWNICON", Utils.getimage("showMore"));
            request.setAttribute("UPICON", Utils.getimage("showLess"));
            
            ItemCategoryDAO dao = new ItemCategoryDAO();
            List<ItemCategoryDTO> dto = dao.getCategoryList();
            request.setAttribute("ADCATEGORY", dto);
            
            ItemStatusDAO stdao = new ItemStatusDAO();
            stdao.getStatusList();
            List<ItemStatusDTO> stdto= stdao.getList();
            request.setAttribute("ADSTATUSLIST", stdto);
