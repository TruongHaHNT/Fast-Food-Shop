<%-- 
    Document   : UserHistoryManagement
    Created on : Mar 1, 2020, 10:14:37 AM
    Author     : SE130204
--%>
        ...
        <div class="containerMain">
                    ...
                    <div class="search">
                        ...
                        <!--search box========================================================================-->
                                <div class="advSearchBox">
                                    <!--search bar============================-->
                                    <input type="hidden" name="txtAdUserID" value="${param.txtAdUserID}"/>
                                    <input id="txtsearch" type="text" name="txtAdSearchHistory" value="${param.txtAdSearchHistory}" placeholder="Search Food/Drink"/>
                                    <input id="searchButton" type="submit" name="btAction" value="" onclick="changeValue_PH('View User History','searchButton')" style="background-image: url(${searchicon})"/><br>
           
                                    <!--dat range===================================================--> 
                                    <input class="txtDate" id="minDate" type="date" name="txtAdMinDate" value="${param.txtAdMinDate}" 
                                           placeholder="1753-01-01" min="1753-01-01" max=""
                                                oninput="checkValidDate('minDate', 'maxDate', 'errorDateRange', 'searchButton')"/>
                                        <d>---</d>
                                        <input class="txtDate" id="maxDate" type="date" name="txtAdMaxDate" value="${param.txtAdMaxDate}" 
            ...
            <nav class="menubar">
                <form action="updateAndCreate" method="POST">
                    ...
                    <input class="navReturn" type="submit" name="btAction" value="Customers management"/>
                </form>
                <h1>Customer: ${param.txtAdUserID} Purchase History</h1>
            </nav>
                ...
                <c:if test="${not empty itemlist}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="updateAndCreate" method="POST">
                                                ...
                                                <input type="submit" name="btAction" value="View this Product">
                                            </form>
                                        </td>
                    ...
                    <div class="Pagging">
                        ...
                        <div class="pagecontainer">
                            <form action="updateAndCreate" method="POST">
                                <input type="hidden" name="btAction" value="View User History"/>
                                <input type="hidden" name="txtAdUserID" value="${param.txtAdUserID}"/>
                                <input type="hidden" name="txtAdSearchHistory" value="${param.txtSearchHistory}"/>
                                <input type="hidden" name="txtAdMinDate" value="${param.txtAdMinDate}"/>
                                <input type="hidden" name="txtAdMaxDate" value="${param.txtAdMaxDate}"/>
            <!--===============================================================================================--> 
